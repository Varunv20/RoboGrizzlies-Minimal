...
public class StandardTrackingWheelLocalizer extends ThreeTrackingWheelLocalizer {
    ...
    public static double LATERAL_DISTANCE = 12.2835; //12.26221083391694; // 12.25 in; distance between the left and right wheels
    public static double FORWARD_OFFSET = -6.5; // in; offset of the lateral wheel

    public static double X_MULTIPLIER = 1.00597999; // Multiplier in the X direction
    public static double Y_MULTIPLIER = 1.00952741;//0.9932; //1.01677682; // Multiplier in the Y direction
    ...
    public StandardTrackingWheelLocalizer(HardwareMap hardwareMap, List<Integer> lastTrackingEncPositions, List<Integer> lastTrackingEncVels) {
        super(Arrays.asList(
                ...
                new Pose2d(FORWARD_OFFSET, 0.01574803, Math.toRadians(90)) // front
        ));
